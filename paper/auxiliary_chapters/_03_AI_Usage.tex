...
\newcommand{\usageReview}{Methodology and Content Review}
...
\usageReview \\
  ...
  \sol &
\texttt{PDF Reader Functionality}; Überprüfe den finalen Draft der Arbeit im Detail auf inhaltliche, methodische und formale Probleme. Gleiche die Arbeit mit den formalen Anforderungen für WABs sowie dem Bewertungsbogen der Hochschule ab und bewerte sie aus der Perspektive eines strengen Prüfers. Identifiziere insbesondere Fehler, die vor der Abgabe noch behoben werden &sollten.
\usageReview \\
  \hline
\end{xltabular}
