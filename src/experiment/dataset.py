...
def det_seed(base_seed: int, particle_count: int, dataset_id: int, coverage: float = 0.1) -> int:
    ...
    payload = f"{base_seed}:{particle_count}:{dataset_id}:{coverage}".encode("utf-8")
